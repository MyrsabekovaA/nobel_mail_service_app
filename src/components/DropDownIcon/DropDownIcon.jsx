...
const DropDownIcon = ({
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {isOpen && (
        <div
          className="absolute right-0 mt-2 shadow-lg w-40 bg-whiten text-graydark flex h-70 flex-col rounded-sm
                 border border-stroke shadow-default dark:border-strokedark dark:bg-compdark sm:right-0 sm:w-30
                 dropdown cursor-pointer z-50"
        >
          {options.map((option, index) => (
            ...
            >
              <li
                className="flex gap-4 border-t border-stroke px-2 py-3 hover:bg-gray-2 items-center
              ...
              >
                ...
                <span className="text-sm font-medium dark:text-white text">
                  {option.text}
                </span>
              </li>
            </ul>
