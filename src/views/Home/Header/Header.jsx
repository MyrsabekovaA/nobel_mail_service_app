        ...
        <header className={`flex w-full bg-white shadow-md p-1 lg:h-20 h-16 justify-between`}>
            ...
            <div className="flex items-center space-x-4">
                ...
                <Dropdown align="end" id="lang_dropdown">
                    ...
                    <Dropdown.Menu className="bg-white text-gray-800 transition-shadow duration-300 ease-in-out rounded-lg shadow-dropdown w-28 p-2" style={{ width: '114px', maxHeight: '180px' }}>
