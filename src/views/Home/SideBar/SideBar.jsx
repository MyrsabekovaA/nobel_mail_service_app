...
const Sidebar = (props) => {
    ...
    return (
        <div className={`relative bg-white-800 ${sidebarOpenned ? 'w-70' : 'w-24'} box-border shrink-0 h-full sidebar`}>
            <div>
                <div className={`flex items-center w-full justify-between`}style={{ paddingTop: '20px', paddingRight: 
                '20px', paddingLeft: '30px' }}>
