...
const CreateEmailTemplateForm = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    const req = await fetch(
      "https://mail-service-412008.ey.r.appspot.com/api/mail-templates",
      {
        method: "POST",
        headers: {
  ...
  return (
    ...
    >
      <Link className="action-btn delete-btn" to="../">
        Back
      </Link>
      <Form onSubmit={handleSubmit}>
        <label htmlFor="files" className="cursor-pointer action-btn">
          Select Files
          <input
            type="file"
            accept=".html"
        ...
        <input type="submit" className="action-btn delete-btn" />
      </Form>
