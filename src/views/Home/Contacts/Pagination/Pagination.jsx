...
function Pagination({ currentPage, totalPages, onChange, contactsPerPage, totalContacts }) {
    ...
    return (
        <div className='flex flex-col gap-2 items-center justify-center flex-wrap pt-4'>
            ...
            <div className='text-sm font-normal text-black dark:text-gray-400 mb-4 md:mb-0 md:inline md:w-auto'>
                Showing 
                <span className='font-semibold text-gray-900 dark:text-white'> {startIndex}-{endIndex}</span> of 
                <span className='font-semibold text-gray-900 dark:text-white'> {totalContacts}</span>
            </div>
        </div>
    );
}
