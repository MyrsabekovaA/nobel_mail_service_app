   ...
   return (
      ...
      >
         <div 
            ...
            className='bg-white flex flex-col dark:bg-slate-800 rounded-lg shadow-xl p-6 w-auto sm:w-96 min-h-[650px] min-w-[550px] overflow-y-auto'>
            <div className='flex justify-between items-center pb-4 px-4 -mx-6'>
               <h2 className='text-xl text-slate-600 dark:text-slate-200 font-bold'>
                  Editing {contactsToEdit.length === 0 ? (totalContacts): (contactsToEdit.length)} contact{contactsToEdit.length > 1 || contactsToEdit.length === 0 ? ('s') : ('')}
               </h2>
               <button
                  onClick={onClose}
               ...
               <div className='actions bg-slate-300 dark:bg-gray-900 flex-auto w-32 px-3'>
                  ...
                  <ul className='flex flex-col gap-3'>
                     <li className='action-item'>
                        <button 
                        className={`tab-button ${currentTab === 'edit' ? 'active-tab' : ''}`}
                     ...
                     <li className='action-item'>
                        <button 
                           className={`tab-button ${currentTab === 'addToEq' ? 'active-tab' : ''}`}
                     ...
                     <li className='action-item'>
                        <button 
                           className={`tab-button ${currentTab === 'removeFromEq' ? 'active-tab' : ''}`}
                     ...
                     <li className='action-item'>
                        <button 
                           className={`tab-button ${currentTab === 'sendEmail' ? 'active-tab' : ''}`}
